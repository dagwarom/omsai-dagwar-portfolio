        ...
        >
          ...
          {project.tools && project.tools.length > 0 && (
            <div className="space-y-3 pt-4">
              <div className="text-sm font-light tracking-widest uppercase text-muted-foreground font-mono">
                // tools
              </div>
              <div className="flex flex-wrap gap-2">
                {project.tools.map((t) => (
                  <span key={t} className="px-3 py-1 text-xs md:text-sm font-light border border-border rounded-sm bg-accent/40">
                    {t}
                  </span>
                ))}
              </div>
          ...
          {project.link && (
            <div className="pt-2">
              <a
                ...
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-sm border border-border text-sm font-light hover:bg-accent transition"
              >
                View on GitHub
              </a>
            </div>
